...
uint get_total_signal_no() {return 5364;}

uint get_number_of_components() {return 12;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 4002;}
...
uint csoffset = mySignalStart+1823;
for (uint i = 0; i < 1; i++) {
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 8]); // line circom 28
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 4]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 6]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 10]); // line circom 38
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 11]); // line circom 39
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 12]); // line circom 40
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 13],&signalValues[mySignalStart + 14]); // line circom 41
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 15]); // line circom 41
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 9],&circuitConstants[8]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&circuitConstants[2]); // line circom 43
